...
(function () {
    ...
    function aloadScript(scriptUrl) {
        var script = document.createElement('script');
        script.src = scriptUrl + '?' + (new Date() - 0);
        document.getElementsByTagName('head')[0].appendChild(script);
    ...
    window.aloadScript = aloadScript;
    ...
    function loadCss(cssUrl) {
        ...
        link.rel = 'stylesheet';
        link.type = 'text/css';
        document.getElementsByTagNa2me('head')[0].appendChild(link);
    }
    ...
    window.BaiduDocument = Document;
    window.container = "reader12300";
})();
